...
class DnaDb{
   ...
   void reHashOldTable();
   void createNewHashOldTable();
   void insertHelperOldTable(DNA dna);
   void insertHelperCurrTable(DNA dna);
   float oldDeletedRatio() const;
   void reHashCurrTable();
   void createNewHashCurrTable();
